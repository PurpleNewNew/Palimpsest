...
const atomSchema = z.object({
  ...
  atom_name: z.string(),
  atom_type: z.string(),
  atom_content_path: z.string().nullable(),
  atom_proof_type: z.string(),
  atom_proof_status: z.string(),
  atom_proof_plan_path: z.string().nullable(),
  atom_proof_result_path: z.string().nullable(),
