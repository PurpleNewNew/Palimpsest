...
const docs = `### Overview
Loads Palimpsest typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Palimpsest Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Palimpsest Mono Sample</div>
    </div>
  ),
}
