...
import { useReducedMotion } from "@palimpsest/ui/hooks"
...
import { InlineInput } from "@palimpsest/ui/inline-input"
import { animate, type AnimationPlaybackControls, clearFadeStyles, FAST_SPRING } from "@palimpsest/ui/motion"
import { showToast } from "@palimpsest/ui/toast"
import { useDialog } from "@palimpsest/ui/context/dialog"
import { usePluginWebHost, type PluginWebHostSync } from "../../host-web"
import { useSessionID } from "./session-id"
import { SessionContextUsage } from "./session-context-usage"

export type SessionTimelineHeaderProps = {
  centered: boolean
  showHeader: () => boolean
  sessionKey: () => string
...
export function SessionTimelineHeader(props: SessionTimelineHeaderProps) {
  ...
  const saveTitleEditor = async () => {
    ...
    await sdk.client.session
      ...
      .then(() => {
        sync.set(
          produce((draft: PluginWebHostSync["data"]) => {
