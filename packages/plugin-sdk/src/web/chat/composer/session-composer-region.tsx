...
import { getSessionHandoff, setSessionHandoff } from "../handoff"
...
import { SessionWorkflowDock } from "./session-workflow-dock"

export type SessionComposerPromptInputProps = {
  class?: string
...
export type SessionComposerRegionProps = {
