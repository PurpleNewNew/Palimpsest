 ...
 *
 * Migrated from `apps/web/src/pages/session/history-window.ts` in
 * Phase 2.3 of the host context promotion. No host dependencies; the
 * `same()` array-equality helper from `@/utils/same` (6 lines) is
 * inlined below to avoid pulling apps/web utils into plugin-sdk.
 */
