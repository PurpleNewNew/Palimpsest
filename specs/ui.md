...
Decisions 2 and 3 are **not yet surfaced in code** — the host today
still eagerly creates node sessions in `atoms-tab.tsx:191-205` (the
squatting code). Part of step 9 work.
