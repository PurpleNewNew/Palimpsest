...
beforeAll(async () => {
  ...
  mock.module("@palimpsest/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@palimpsest/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@palimpsest/ui/icon", () => ({ Icon: () => null }))
  mock.module("@palimpsest/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
