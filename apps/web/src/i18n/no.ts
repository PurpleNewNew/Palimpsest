...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Palimpsest",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Palimpsest.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Palimpsest.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Palimpsest.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i palimpsest.json",
  ...
  "dialog.server.description": "Bytt hvilken Palimpsest-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Palimpsest ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Palimpsest-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (palimpsest.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Palimpsest ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Palimpsest inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Palimpsest-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Palimpsest",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Palimpsest ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Palimpsest er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Palimpsest starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Palimpsest.",
