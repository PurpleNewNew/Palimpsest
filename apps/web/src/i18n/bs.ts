export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Palimpsest",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Palimpsest-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Palimpsest-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Palimpsest-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u palimpsest.json",
  ...
  "dialog.server.description": "Promijeni na koji se Palimpsest server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Palimpsest-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Palimpsest timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (palimpsest.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Palimpsest još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Palimpsest uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Palimpsest server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Palimpsest-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Palimpsest izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Palimpsest-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Palimpsest pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Palimpsest-a.",
