export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Palimpsest",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Palimpsest.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Palimpsest.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Palimpsest.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w palimpsest.json",
  ...
  "dialog.server.description": "Przełącz serwer Palimpsest, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Palimpsest ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Palimpsest",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (palimpsest.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Palimpsest zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Palimpsest",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Palimpsest na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Palimpsest.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Palimpsest",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Palimpsest.",
