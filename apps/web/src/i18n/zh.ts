...
export const dict = {
  ...
  "command.session.share": "发布会话归档",
  "command.session.share.description": "将此会话发布为兼容的归档链接，并将 URL 复制到剪贴板",
  "command.session.unshare": "取消发布会话归档",
  "command.session.unshare.description": "停止发布此会话归档",
  ...
  "dialog.model.unpaid.freeModels.title": "Palimpsest 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Palimpsest 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Palimpsest 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Palimpsest 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 palimpsest.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Palimpsest 服务器。",
  ...
  "toast.session.share.copyFailed.title": "无法复制归档链接到剪贴板",
  "toast.session.share.success.title": "会话归档已发布",
  "toast.session.share.success.description": "归档链接已复制到剪贴板",
  "toast.session.share.failed.title": "发布会话归档失败",
  "toast.session.share.failed.description": "发布会话归档时发生错误",
  "toast.session.unshare.success.title": "会话归档已取消发布",
  "toast.session.unshare.success.description": "会话归档已成功取消发布",
  "toast.session.unshare.failed.title": "取消发布失败",
  "toast.session.unshare.failed.description": "取消发布会话归档时发生错误",
  "toast.session.listFailed.title": "无法加载 {{project}} 的会话",
  "toast.update.title": "有可用更新",
  "toast.update.description": "Palimpsest 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Palimpsest 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (palimpsest.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Palimpsest 暂不支持 MCP 认证。',
  ...
  "session.share.popover.title": "发布归档到网页",
  "session.share.popover.description.shared": "此会话归档已在网页上公开。任何拥有链接的人都可以访问。",
  "session.share.popover.description.unshared": "将此会话作为归档发布到网页。它会作为对象工作面的兼容公开入口存在。",
  "session.share.action.share": "归档链接",
  "session.share.action.publish": "发布归档",
  "session.share.action.publishing": "正在发布归档...",
  "session.share.action.unpublish": "取消发布归档",
  "session.share.action.unpublishing": "正在取消发布归档...",
  "session.share.action.view": "打开归档",
  "session.share.copy.copied": "已复制",
  "session.share.copy.copyLink": "复制归档链接",
  ...
  "sidebar.gettingStarted.line1": "Palimpsest 仍在重建中。先打开一个工作区，查看当前图谱和会话。",
  "sidebar.gettingStarted.line2": "连接你需要的模型提供商，然后在 Web 工作区里发起提案、审阅和运行。",
  ...
  "settings.general.row.language.description": "更改 Palimpsest 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Palimpsest 在浏览器中的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Palimpsest 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Palimpsest 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用当前可用的最新 Palimpsest 构建。",
