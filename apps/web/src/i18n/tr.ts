...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Palimpsest tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Palimpsest'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Palimpsest'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Palimpsest'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler palimpsest.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Palimpsest sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Palimpsest'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Palimpsest ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (palimpsest.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Palimpsest henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Palimpsest ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "Palimpsest sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Palimpsest'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Palimpsest'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Palimpsest'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Palimpsest başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Palimpsest'un en son sürümünü kullanıyorsunuz.",
