...
const serverEnv = {
  ...process.env,
  PALIMPSEST_DISABLE_SHARE: process.env.PALIMPSEST_DISABLE_SHARE ?? "true",
  PALIMPSEST_DISABLE_LSP_DOWNLOAD: "true",
  PALIMPSEST_DISABLE_DEFAULT_PLUGINS: "true",
  PALIMPSEST_EXPERIMENTAL_DISABLE_FILEWATCHER: "true",
  PALIMPSEST_TEST_HOME: path.join(sandbox, "home"),
  XDG_DATA_HOME: path.join(sandbox, "share"),
  XDG_CACHE_HOME: path.join(sandbox, "cache"),
  XDG_CONFIG_HOME: path.join(sandbox, "config"),
  XDG_STATE_HOME: path.join(sandbox, "state"),
  PALIMPSEST_E2E_PROJECT_DIR: repoDir,
  PALIMPSEST_E2E_SESSION_TITLE: "E2E Session",
  PALIMPSEST_E2E_MESSAGE: "Seeded for UI e2e",
  PALIMPSEST_E2E_MODEL: "opencode/gpt-5-nano",
  PALIMPSEST_CLIENT: "app",
...
const runnerEnv = {
  ...
  VITE_PALIMPSEST_SERVER_HOST: "127.0.0.1",
  VITE_PALIMPSEST_SERVER_PORT: String(serverPort),
