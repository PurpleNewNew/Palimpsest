  ...
  new Hono()
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Palimpsest sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Palimpsest session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Palimpsest session for interacting with AI assistants and managing conversations.",
