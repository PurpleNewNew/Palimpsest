...
function App() {
  ...
  useKeyboard((evt) => {
    if (!Flag.PALIMPSEST_EXPERIMENTAL_DISABLE_COPY_ON_SELECT) return
  ...
  return (
    <box
      ...
      onMouseUp={Flag.PALIMPSEST_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? undefined : () => Selection.copy(renderer, toast)}
    >
      <Switch>
