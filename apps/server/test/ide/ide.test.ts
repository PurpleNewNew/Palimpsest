...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders PALIMPSEST_CALLER", () => {
    process.env["PALIMPSEST_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode PALIMPSEST_CALLER", () => {
    process.env["PALIMPSEST_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown PALIMPSEST_CALLER", () => {
    process.env["PALIMPSEST_CALLER"] = "unknown"
