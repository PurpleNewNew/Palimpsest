...
### apps/server (current server runtime)
...
- Use `tmpdir` fixture from `apps/server/test/fixture/fixture.ts` for tests needing filesystem
...
- **Schema**: Drizzle schema lives in `apps/server/src/**/*.sql.ts`
